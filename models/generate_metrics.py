...
if __name__ == '__main__':
    get_predictions(karpathy_json_path='dataset/atlas_dataset.json',
                    ...
                    model_path='models/output/BEST_checkpoint_atlas_1_cap_per_img_1_min_word_freq.pth.tar',
                    word_map_path='models/output/WORDMAP_atlas_1_cap_per_img_1_min_word_freq.json',
                    beam_size=5,
                    predictions_file_path='models/output/model_predictions_cbs.csv'
                    )
    get_metrics_from_predictions(predictions_file_path='models/output/model_predictions_cbs.csv',
