...
df = pd.read_csv("./fashion_small/styles.csv", on_bad_lines="skip", nrows=100) #nrows = 100 (100 anh dau)
...
# folder_path = "./fashion_small/resized_images"
# with open("img_test.txt", "w") as file:
...
image_folder = './fashion_small/resized_images'
...
path_json = "./fashion_small_dataset.json"
